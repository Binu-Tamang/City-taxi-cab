        ...
        <div class="page_body_wrap page_body_wrap_reserv">
            <div class="page_body page_body_reserv">
                <div class="reservbodywrap">
                    ...
                    <!-- Airport Drop -->
                    <form class="cssform row reservtype airportdrop" action="php/reserv-form-airport-drop.php"
                        ...
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            ...
                            <input type="number" name="nopassengers" placeholder="No. of Passengers" min="1" max="30"
                                required>
                        </div>
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            <label>Luggage:*</label>
                            <input type="number" name="luggage" placeholder="No. of Luggage" min="1" max="40" required>
                        </div>
                        ...
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            ...
                            <input name="pickupdate" type="text" value="" placeholder="Pick Up Date"
                                class="form-control" id="checkin1" required="required" data-error="Please specify date">
                        </div>
                        ...
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            ...
                            <input type="text" name="statezipa" placeholder="City/Town" required>
                        </div>
                    ...
                    <!-- Airport Drop Roundtrip -->
                    <form class="cssform row reservtype airportdrop-roundtrip"
                        action="php/reserv-form-airport-drop-roundtrip.php" method="post" enctype="multipart/form-data"
                        ...
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            <label>Passengers:*</label>
                            <input type="number" name="nopassengers" placeholder="No. of Passengers" min="1" max="100"
                                required>
                        </div>
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            <label>Luggage:*</label>
                            <input type="number" name="luggage" placeholder="No. of Luggage" min="1" max="100" required>
                        </div>
                        <h4 class="col-md-12 col-sm-12 col-xs-12">Pick up Location #1</h4>
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            <label>Pick-up Date:*</label>
                            <input name="pickupdate2" type="text" value="" placeholder="Pick Up Date"
                                class="form-control" id="checkin4" required="required" data-error="Please specify date">
                        </div>
                        ...
                        <h4 class="col-md-12 col-sm-12 col-xs-12">Drop-off location #1 - Airport</h4>
                        ...
                        <h4 class="col-md-12 col-sm-12 col-xs-12">Pick up Location #2 - Airport</h4>
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            <label>Pick-up Date:*</label>
                            <input name="pickupdate1" type="text" value="" placeholder="Pick Up Date"
                                class="form-control" id="checkin3" required="required" data-error="Please specify date">
                        </div>
                        ...
                        <h4 class="col-md-12 col-sm-12 col-xs-12">Drop-off location #2</h4>
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            <label>Street Address: *</label>
                        ...
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            <label>State / ZIP Code:*</label>
                            <input type="text" name="statezipa2" placeholder="City/Town" required>
                        </div>
                    ...
                    <!-- Airport PickUp -->
                    <form class="cssform row reservtype airportpickup-oneway"
                        ...
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            <label>Pick-up Date:*</label>
                            <input name="pickupdate" type="text" value="" placeholder="Pick Up Date"
                                class="form-control" id="checkin2" required="required" data-error="Please specify date">
                        </div>
                    ...
                    <form class="cssform row reservtype airportpickup-roundtrip"
                        ...
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            <label>Pick-up Date:*</label>
                            <input name="pickupdate1" type="text" value="" placeholder="Pick Up Date"
                                class="form-control" id="checkin5" required="required" data-error="Please specify date">
                        </div>
                        ...
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            <label>Pick-up Date:*</label>
                            <input name="pickupdate2" type="text" value="" placeholder="Pick Up Date"
                                class="form-control" id="checkin6" required="required" data-error="Please specify date">
                        </div>
                    ...
                    <!-- Other -->
                    <form class="cssform row reservtype other" action="php/reserv-form-others.php" method="post"
                        enctype="multipart/form-data" name="frm" id="frm" onSubmit="return validate(this)">
                        <h4 class="col-md-12 col-sm-12 col-xs-12">Passenger Information</h4>
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            <label>First Name:*</label>
                        ...
                        <div class="formfield col-md-4 col-sm-6 col-xs-12">
                            <label>Pick-up Date:*</label>
                            <input name="pickupdate" type="text" value="" placeholder="Pick Up Date"
                                class="form-control" id="checkin7" required="required" data-error="Please specify date">
                        </div>
