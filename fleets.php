...
<head>
    <title>City Taxi | Our Fleets</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <!-- fleets section starts -->
    <section class="main-wrap-fleets">
        <div class="container">
            <h2 class="main-banner-header">Our <span>Fleets</span></h2>
            <div class="main-page-fleets">
                <div class="row">
                    <div class="col-md-4">
