...
<body>
    ...
    <!-- section of area we serve -->
    <section class="area-serve">
        <div class="contianer">
            <h2 class="main-banner-header">Areas We Serve</h2>
            <p>"We provide cab services in the following key cities. Our fleet of vehicles is available for
                convenient and reliable transportation within these regions."</p>
